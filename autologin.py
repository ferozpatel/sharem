...
CLIENT_ID = "YF00368"       # Your Fyers Client ID
PIN = "1437"                # User pin for Fyers account
#APP_ID = "MCO4RO1YDC"        # App ID from MyAPI dashboard (https://myapi.fyers.in/dashboard). The format is appId-appType.
APP_ID = "TAN9RM9WZW"
# Example: YIXXXXXSE-100. In this code, YIXXXXXSE is the APP_ID and 100 is the APP_TYPE
#APP_TYPE = "100"
APP_TYPE = "200"
#APP_SECRET = "D9WE72QCHD"   # App Secret from myapi dashboard (https://myapi.fyers.in/dashboard)
APP_SECRET = "PkLoz1i2oYnV67ad"
TOTP_SECRET_KEY = "MKI3KNLSERQHGJ73W3WVFHXEYHDZFIGV"  # TOTP secret key, copy the secret while enabling TOTP.
...
def main():
    ...
    appidd = APP_ID + "-" + APP_TYPE
    print(f"\naccess_token - {access_token}\n")

    #save client id and access token to file
    ACCTOKEN = validate_authcode_result[1]
...
if __name__ == "__main__":
    main()
client_id = "MCO4RO1YDC-100"
# client_id = "YF00368"
print("ACCTOKEN=",ACCTOKEN, " client_id==",client_id)
fyers = fyersModel.FyersModel(token=ACCTOKEN,is_async=False,client_id=client_id,log_path="")